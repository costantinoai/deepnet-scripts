...
dls = make_dls(stim_path, batch_sz)
# print('\nShowing first batch...')
...
if log:
    ...
    run_name = f'{timestamp}_fb-{fb}_pretr-{pretrained}_ContrLoss_samediff_adam_bs-{batch_sz}_lr-{lr_min}_f1c-{f1c}_{cycles}x{epochs}'
